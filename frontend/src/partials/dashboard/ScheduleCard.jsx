...
function ScheduleCard() {
  ...
  useEffect(() => {
    ...
    const url = new URL('../../../public/final_schedule.csv', window.location.origin).toString();
  ...
  return (
    <div className="col-span-full bg-white dark:bg-gray-800 shadow-xs rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">Physician Schedule</h2>
      </header>
