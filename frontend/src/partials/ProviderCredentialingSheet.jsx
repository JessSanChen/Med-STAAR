// src/partials/ProviderCredentialingSheet.jsx
    ...
    (async () => {
      try {
        ...
        if (!res.ok || ctype.includes('text/html') || text.startsWith('<!DOCTYPE')) {
          throw new Error('CSV not found at /provider_credentialing.csv (got HTML). Put the file in /public.');
        }
